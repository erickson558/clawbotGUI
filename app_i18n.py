...
TEXTS = {
    "es": {
        ...
        "label_console_hint": "Salida embebida en modo silent. La GUI lanza el gateway en oculto y todo el stdout/stderr aparece aquí sin abrir una ventana CMD separada.",
    ...
    "en": {
        ...
        "label_console_hint": "Embedded silent output. The GUI launches the gateway hidden and all stdout/stderr is shown here without opening a separate CMD window.",
        "button_start": "Start",
        "button_stop": "Stop",
